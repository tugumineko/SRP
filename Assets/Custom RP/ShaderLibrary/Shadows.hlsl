...
#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/Shadow/ShadowSamplingTent.hlsl"
    ...
    #define _OTHER_FILTER_SAMPLES 4
    #define _OTHER_FILTER_SETUP SampleShadow_ComputeSamples_Tent_3x3
#elif defined(_OTHER_PCF5)
    #define _OTHER_FILTER_SAMPLES 9
    #define _OTHER_FILTER_SETUP SampleShadow_ComputeSamples_Tent_5x5
#elif defined(_OTHER_PCF7)
    #define _OTHER_FILTER_SAMPLES 16
    #define _OTHER_FILTER_SETUP SampleShadow_ComputeSamples_Tent_7x7
#endif
...
float GetCascadedShadow(DirectionalShadowData directional, ShadowData global,Surface surfaceWS)
{
    ...
    if (global.cascadeBlend < 1.0f)
    {
        ...
        positionSTS = mul(
            ...
            float4(surfaceWS.position + normalBias,1.0f)
            ).xyz;
